...
public class ShrublandsBiome {
    public static final RegistryKey<Biome> KEY = RegistryKey.of(Registry.BIOME_KEY, new Identifier(NaturesCanvas.MOD_ID, "shrublands"));
    ...
    public static Biome create() {
        ...
        return new Biome.Builder()
                ...
                .temperature(ModBiomeEffects.WARM_TEMPERATURE) //Default is 1.2f
                .downfall(ModBiomeEffects.WARM_DOWNFALL) //Default is 0.2f
