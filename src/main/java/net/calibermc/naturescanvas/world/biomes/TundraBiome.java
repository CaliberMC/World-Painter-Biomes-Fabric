...
public class TundraBiome {
    public static final RegistryKey<Biome> KEY = RegistryKey.of(Registry.BIOME_KEY, new Identifier(NaturesCanvas.MOD_ID, "tundra"));
    ...
    public static Biome create() {
        ...
        return new Biome.Builder()
                ...
                .downfall(ModBiomeEffects.COLD_DOWNFALL - 0.5f) //Default is 0.9f
