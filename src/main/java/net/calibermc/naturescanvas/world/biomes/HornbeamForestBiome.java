...
public class HornbeamForestBiome {
    public static final RegistryKey<Biome> KEY = RegistryKey.of(Registry.BIOME_KEY, new Identifier(NaturesCanvas.MOD_ID, "hornbeam_forest"));
    ...
    public static Biome create() {
        ...
        return new Biome.Builder()
                ...
                .temperature(ModBiomeEffects.DECIDUOUS_FOREST_TEMPERATURE)  //Default is .6f
                .downfall(ModBiomeEffects.DECIDUOUS_FOREST_DOWNFALL)  //Default is .7f
