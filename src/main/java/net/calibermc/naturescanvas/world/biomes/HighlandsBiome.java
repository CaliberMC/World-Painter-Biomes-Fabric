...
public class HighlandsBiome {
    public static final RegistryKey<Biome> KEY = RegistryKey.of(Registry.BIOME_KEY, new Identifier(NaturesCanvas.MOD_ID, "highlands"));
    ...
    public static Biome create() {
        ...
        return new Biome.Builder()
                ...
                .temperature(ModBiomeEffects.TEMPERATE_TEMPERATURE - .2f) //Default is .8f
                .downfall(ModBiomeEffects.TEMPERATE_DOWNFALL + .1f) //Default is 0.4f
                .effects(new BiomeEffects.Builder()
                        .waterColor(ModBiomeEffects.TEMPERATE_WATER_COLOR)
                        .skyColor(ModBiomeEffects.TEMPERATE_SKY_COLOR)
                        .grassColor(ModBiomeEffects.HIGHLANDS_GRASS_COLOR)
